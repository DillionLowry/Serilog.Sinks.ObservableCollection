...
/// If no logs were generated within the specified batch time, <see cref="OnEmptyBatchAsync"/> is called.
/// </remarks>
public class ObservableCollectionSink : ILogEventSink, IBatchedLogEventSink, IDisposable
{
    ...
    {
        // If batching is enabled, Emit is handled by Serilog's native batching
